...
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-LibYAML-0.89.tar.gz
...
%prep
%setup -q -n YAML-LibYAML-0.89
cd %{_builddir}/YAML-LibYAML-0.89
pushd ..
cp -a YAML-LibYAML-0.89 buildavx2
popd
