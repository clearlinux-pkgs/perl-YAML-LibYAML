...
%prep
%setup -q -n YAML-LibYAML-0.81
cd %{_builddir}/YAML-LibYAML-0.81
...
cp %{_builddir}/YAML-LibYAML-0.81/LICENSE %{buildroot}/usr/share/package-licenses/perl-YAML-LibYAML/19d40da3bc981cec880a2112a7e2646d480cb6f4
if test -f Makefile.PL; then
