...
Source0  : https://cpan.metacpan.org/authors/id/T/TI/TINITA/YAML-LibYAML-v0.901.0.tar.gz
...
%prep
%setup -q -n YAML-LibYAML-v0.901.0
cd %{_builddir}/YAML-LibYAML-v0.901.0
pushd ..
cp -a YAML-LibYAML-v0.901.0 buildavx2
popd
